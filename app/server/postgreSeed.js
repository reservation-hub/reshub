...
const userRepository = require('./src/repositories/postgre/userRepository')
const roleRepository = require('./src/repositories/postgre/roleRepository')
const locationRepository = require('./src/repositories/postgre/locationRepository')
